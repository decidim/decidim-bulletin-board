...
If your voting needs to be integrated with a physical election, here you can create the Polling Stations for which the https://www.notion.so/Create-and-configure-a-Voting-7d8c12536de448d38d00718430860762[Polling Officers] will register and submit votes to the Bulletin Board.
...
Once you have created a Polling Officer, remember to assign them to their https://www.notion.so/Create-and-configure-a-Voting-7d8c12536de448d38d00718430860762[Polling Station] from the Polling Station itself.
