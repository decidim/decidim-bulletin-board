...
After a https://www.notion.so/Create-and-configure-a-Voting-7d8c12536de448d38d00718430860762[Decidim admin made a user a Polling Officer] and assigned them to a Polling Station, the user will be able to access the Polling Officer Zone and see their Polling Stations.
...
Notice that the voter had the possibility https://www.notion.so/Check-census-data-and-recover-access-code-3865fc720a6e452589f37d752ef65617[check if they were correctly enlisted in the census] the days prior the election.
