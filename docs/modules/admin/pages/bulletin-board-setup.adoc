...
In https://www.notion.so/Bulletin-Board-setup-628285559eea4350b0ec0165ee922ece[the previous step], the Bulletin Board administrator added your Decidim instance as an authority in the Bulletin Board and sent you back an API key.
