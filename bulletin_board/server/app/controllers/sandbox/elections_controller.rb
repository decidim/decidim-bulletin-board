...
module Sandbox
  class ElectionsController < ApplicationController
    helper_method :elections, :election,
                  ...
                  :default_bulk_votes_number, :bulk_votes_file_name, :bulk_votes_file_exists?, :generated_votes_number, :bulk_votes_file_url, :bulk_votes_file_update_time, :bulk_votes_url_set?
                  :pending_message
