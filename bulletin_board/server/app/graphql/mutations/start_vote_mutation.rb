...
module Mutations
  class StartVoteMutation < BaseMutation
    ...
    def resolve(message_id:, signed_data:)
      ...
      result = { error: "There was an error starting the election's voting period." }

      EnqueueMessage.call(authority, message_id, signed_data, StartVoteJob) do
