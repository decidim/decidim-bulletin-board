...
dev_trustees_private_keys = PrivateKeys.dev_trustees_private_keys_json.map { |trustee_private_key_json| Decidim::BulletinBoard::JwkUtils.import_private_key(trustee_private_key_json) }
