        ...
        context "when everything is ok" do
          let(:create_election_message) do
            { scheme: { name: "test", quorum: 2 },
              ...
              trustees: [{ name: "trustee 1", slug: "trustee-1", public_key: "the public key 1" },
                         { name: "trustee 2", slug: "trustee-2", public_key: "the public key 2" }],
